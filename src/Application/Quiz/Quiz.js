    ...
    <div className="quiz">
      ...
      {score ? (
        <div className="result">
          <h3>Your result:</h3>
          <p>{score}</p>
          <p>Curing depression is a complex and individualized process. It typically involves a combination of therapeutic approaches, lifestyle changes, and sometimes medication. Therapy, such as cognitive-behavioral therapy (CBT) or interpersonal therapy, helps individuals understand and manage their thoughts and emotions. Support from friends and family can also be invaluable. Additionally, adopting a healthy lifestyle, including regular exercise, a balanced diet, and sufficient sleep, can significantly aid in managing depression. In some cases, medication prescribed by a healthcare professional may be necessary to rebalance brain chemistry. While depression may not always be completely cured, with the right treatment and support, individuals can effectively manage their symptoms and lead fulfilling lives.</p>
        </div>
      ) : (
